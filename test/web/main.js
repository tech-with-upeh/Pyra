...
var ASM_CONSTS = {
  84956: ($0) => { document.body.innerHTML = UTF8ToString($0); },  
 85004: ($0) => { document.title = UTF8ToString($0); },  
 85043: ($0, $1) => { document.body.setAttribute(UTF8ToString($0), UTF8ToString($1)); },  
 85111: ($0) => { console.log("WASM Module Loaded", window.location.pathname); if (typeof window !== 'undefined') { window.wasmModuleReady = true; console.log("WASM Module is ready."); if (window.location.pathname == "/about") { console.log("Initial route:", window.location.pathname); Module.ccall('navigateTo', null, ['string'], [UTF8ToString($0)]); } } },  
 85453: ($0, $1) => { window.wasmState = window.wasmState || {}; if (window.wasmState[UTF8ToString($0)] === undefined) { window.wasmState[UTF8ToString($0)] = $1; } },  
 85599: ($0, $1) => { window.wasmState = window.wasmState || {}; window.wasmState[UTF8ToString($0)] = $1; },  
 85687: ($0) => { window.wasmState = window.wasmState || {}; var val = window.wasmState[UTF8ToString($0)]; return (val === undefined) ? 0 : val; }
};

// Imports from the Wasm binary.
var _invokeVNodeCallback = Module['_invokeVNodeCallback'] = makeInvalidEarlyAccess('_invokeVNodeCallback');
var _navigateTo = Module['_navigateTo'] = makeInvalidEarlyAccess('_navigateTo');
...
function assignWasmExports(wasmExports) {
  ...
  assert(wasmExports['navigateTo'], 'missing Wasm export: navigateTo');
  _navigateTo = Module['_navigateTo'] = createExportWrapper('navigateTo', 1);
