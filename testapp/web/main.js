...
var ASM_CONSTS = {
  85340: ($0) => { document.body.innerHTML = UTF8ToString($0); },  
 85388: ($0) => { document.title = UTF8ToString($0); },  
 85427: ($0, $1) => { document.body.setAttribute(UTF8ToString($0), UTF8ToString($1)); },  
 85495: () => { console.log(window.location.pathname); Module._handleRoute(allocateUTF8(window.location.pathname)); },  
 85599: ($0, $1) => { window.wasmState = window.wasmState || {}; if (window.wasmState[UTF8ToString($0)] === undefined) { window.wasmState[UTF8ToString($0)] = UTF8ToString($1); } },  
 85759: ($0, $1) => { window.wasmState = window.wasmState || {}; window.wasmState[UTF8ToString($0)] = UTF8ToString($1); },  
 85861: ($0) => { window.wasmState = window.wasmState || {}; var val = window.wasmState[UTF8ToString($0)]; if (val === undefined) { val = ""; } var length = lengthBytesUTF8(val) + 1; var buffer = _malloc(length); stringToUTF8(val, buffer, length); return buffer; }
};
