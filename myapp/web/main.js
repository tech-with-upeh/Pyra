...
var _invokeCallback = Module['_invokeCallback'] = makeInvalidEarlyAccess('_invokeCallback');
var _getCallbackCount = Module['_getCallbackCount'] = makeInvalidEarlyAccess('_getCallbackCount');
...
function assignWasmExports(wasmExports) {
  assert(wasmExports['invokeCallback'], 'missing Wasm export: invokeCallback');
  _invokeCallback = Module['_invokeCallback'] = createExportWrapper('invokeCallback', 1);
  assert(wasmExports['getCallbackCount'], 'missing Wasm export: getCallbackCount');
  _getCallbackCount = Module['_getCallbackCount'] = createExportWrapper('getCallbackCount', 0);
