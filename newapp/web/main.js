...
var ASM_CONSTS = {
 ...
 84547: ($0, $1) => { if (document.getElementById(UTF8ToString($0))) { const ctx = document.getElementById(UTF8ToString($0)).getContext("2d"); ctx.fillStyle = UTF8ToString($1); } },  
 84708: ($0, $1, $2, $3, $4) => { if (document.getElementById(UTF8ToString($0))) { const ctx = document.getElementById(UTF8ToString($0)).getContext("2d"); ctx.fillRect($1, $2, $3, $4); } }
};
