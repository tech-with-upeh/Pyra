...
var ASM_CONSTS = {
  85052: ($0) => { document.body.innerHTML = UTF8ToString($0); },  
 85100: ($0) => { document.title = UTF8ToString($0); },  
 85139: ($0, $1) => { document.body.setAttribute(UTF8ToString($0), UTF8ToString($1)); },  
 85207: () => { console.log(window.location.pathname); Module._handleRoute(allocateUTF8(window.location.pathname)); },  
 85311: ($0, $1) => { window.wasmState = window.wasmState || {}; if (window.wasmState[UTF8ToString($0)] === undefined) { window.wasmState[UTF8ToString($0)] = $1; } },  
 85457: ($0, $1) => { window.wasmState = window.wasmState || {}; window.wasmState[UTF8ToString($0)] = $1; },  
 85545: ($0) => { window.wasmState = window.wasmState || {}; var val = window.wasmState[UTF8ToString($0)]; return (val === undefined) ? 0 : val; }
};
